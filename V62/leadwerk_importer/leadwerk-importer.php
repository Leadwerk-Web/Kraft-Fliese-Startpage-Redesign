 ...
 * Description: Imports the Kraft Fliesen static site into WordPress pages, the Media Library and individually editable Leadwerk fields.
 * Version: 2.2.0
 * Author: Leadwerk
...
define( 'LEADWERK_IMPORTER_VERSION', '2.2.0' );
...
function leadwerk_importer_admin_page() {
	...
	<div class="wrap leadwerk-importer-admin">
		<h1>Kraft Fliesen WordPress Import</h1>
		...
		<div class="notice notice-info inline"><p><strong>Sıra:</strong> Leadwerk WPML Clone → Leadwerk Fields → Leadwerk Importer eklentilerini etkinleştir, <strong>Leadwerk Kraft Fliesen</strong> temasını seç, önce Dry Run sonra Live Import çalıştır. WPForms JSON dosyasını ayrıca WPForms → Tools → Import altında içe aktar ve oluşan form ID’sini Ayarlar → Kraft Fliesen Website alanına yaz.</p></div>
