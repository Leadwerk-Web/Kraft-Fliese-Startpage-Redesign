...
";
	...
	protected static function migrate_legacy_content() {
		...
		foreach ( $query->posts as $post_id ) {
			...
			$is_home    = ! empty( get_post_meta( $post->ID, Leadwerk_Translation_API::META_LANG_ROOT, true ) ) || 'kraft-home' === $source_key || ( Leadwerk_Translation_API::get_default_language() === $lang && (int) get_option( 'page_on_front' ) === (int) $post->ID );
