	...
	public static function link_posts( $source_post_id, $translated_post_id, $target_lang, $translated_is_root = false, $args = array() ) {
		...
		$source_record = self::ensure_post_record(
			...
			array(
				...
				'is_home'       => ! empty( $args['source_is_home'] ) || 'kraft-home' === get_post_meta( $source_post->ID, 'leadwerk_source_key', true ) || (int) get_option( 'page_on_front' ) === (int) $source_post->ID,
				'status'        => 'complete',
			)
		);
